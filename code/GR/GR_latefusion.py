# GR late fusion with CNN and AdaBoost for HI/LI/EYE/MOUTH mask conditions
import os
...
if __name__ == '__main__':
    for experiment in experiments:
        features_eeg,features_gaze,labels,_ = data_load_casebasis(experiment)
        ...
        for train,test in skf.split(features_eeg,labels):
            ...
            #     dl_model.compile(loss='binary_crossentropy', optimizer=sgd, metrics=['accuracy'])
